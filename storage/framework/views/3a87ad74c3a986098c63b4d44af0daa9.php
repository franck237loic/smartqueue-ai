...
<head>
    ...
    <title>Centre d'Appels - <?php echo e($company->name); ?> | SmartQueue AI</title>
    ...
    <main class="py-8">
        <div class="container">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-charcoal"><?php echo e($company->name); ?> - Gestion des Files d'Attente</p>
            </div>
                ...
                <div class="queue-panel">
                    <div class="queue-header">
                        ...
                        <span class="status-waiting px-3 py-1 rounded-full text-sm font-medium">
                            <?php echo e($waitingTickets ?? 12); ?> en attente
                        </span>
                    </div>
                    
                    <div class="queue-stats">
                        <div class="queue-stat">
                            <div class="queue-stat-value"><?php echo e($waitingTickets ?? 12); ?></div>
                            <div class="queue-stat-label">En attente</div>
                        </div>
                        <div class="queue-stat">
                            <div class="queue-stat-value"><?php echo e($servingTickets ?? 3); ?></div>
                            <div class="queue-stat-label">En service</div>
                        </div>
                        <div class="queue-stat">
                            <div class="queue-stat-value"><?php echo e($servedTickets ?? 45); ?></div>
                    ...
                    <div class="ticket-list" id="ticketList">
                        ...
                        <div class="ticket-item <?php echo e($ticket['status']); ?>" data-ticket="<?php echo e($ticket['number']); ?>">
                            <div class="ticket-status <?php echo e($ticket['status']); ?>"></div>
                            <div class="ticket-number"><?php echo e($ticket['number']); ?></div>
                            <div class="ticket-info">
                                <span class="ticket-service"><?php echo e($ticket['service']); ?></span>
                                <span class="ticket-wait-time"><?php echo e($ticket['wait_time']); ?></span>
                            </div>
                        </div>
                    ...
                    <div class="card mt-4">
                        ...
                        <div class="space-y-2">
                            <div class="flex justify-between">
                                ...
                                <strong><?php echo e($processedTickets ?? 45); ?></strong>
                            </div>
                            <div class="flex justify-between">
                                <span>Temps moyen:</span>
                                <strong><?php echo e($avgTime ?? 8.5); ?> min</strong>
                            </div>
                            <div class="flex justify-between">
                                <span>Taux de satisfaction:</span>
                                <strong><?php echo e($satisfaction ?? 92); ?>%</strong>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\Users\FurtherMarket\smartqueue-ai\resources\views\agent\call_center.blade.php ENDPATH**/ ?>