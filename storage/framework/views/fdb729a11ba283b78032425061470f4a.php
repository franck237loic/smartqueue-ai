...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mt-6 pt-6 border-t border-gray-100 text-center">
                <a href="<?php echo e(route('welcome')); ?>" class="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-gray-700 transition group">
        ...
        <p class="mt-6 text-center text-sm text-white/70">
            <?php echo e(date('Y')); ?> SmartQueue AI - Tous droits réservés
        </p>
    </div>
...
<?php /**PATH C:\Users\FurtherMarket\smartqueue-ai\resources\views\auth\login_original.blade.php ENDPATH**/ ?>