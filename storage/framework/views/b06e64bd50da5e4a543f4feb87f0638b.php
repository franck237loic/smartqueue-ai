<?php $__env->startSection('title', 'Modifier Service'); ?>
...
<div class="max-w-2xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <p class="text-dark-600 mt-1"><?php echo e($service->name); ?></p>
    </div>

    <!-- Form -->
    <div class="bg-dark-800 rounded-xl card-shadow p-6">
        <form action="<?php echo e(route('company.admin.services.update', [$company, $service])); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="prefix" value="<?php echo e(old('prefix', $service->prefix)); ?>" required maxlength="10"
                        class="w-full px-4 py-3 bg-dark-900 border border-dark-700 rounded-lg text-white placeholder-dark-600 focus:outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" name="estimated_service_time" value="<?php echo e(old('estimated_service_time', $service->estimated_service_time)); ?>" required min="1"
                        class="w-full px-4 py-3 bg-dark-900 border border-dark-700 rounded-lg text-white placeholder-dark-600 focus:outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500">
                </div>
            </div>
            ...
            <div>
                ...
                <textarea name="description" rows="3"
                    class="w-full px-4 py-3 bg-dark-900 border border-dark-700 rounded-lg text-white placeholder-dark-600 focus:outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500"><?php echo e(old('description', $service->description)); ?></textarea>
            </div>

            <div class="grid grid-cols-2 gap-4">
                <div>
                    <label class="block text-sm font-medium text-dark-600 mb-2">Timeout absence (min) *</label>
                    <input type="number" name="missed_timeout" value="<?php echo e(old('missed_timeout', $service->missed_timeout)); ?>" required min="1"
                        class="w-full px-4 py-3 bg-dark-900 border border-dark-700 rounded-lg text-white placeholder-dark-600 focus:outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500">
                </div>
                <div>
                    ...
                    <select name="status" required
                        ...
                        <option value="active" <?php echo e($service->status === 'active' ? 'selected' : ''); ?>>Actif</option>
                        <option value="inactive" <?php echo e($service->status === 'inactive' ? 'selected' : ''); ?>>Inactif</option>
                    </select>
                </div>
            </div>
...
<?php echo $__env->make('layouts.company-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\FurtherMarket\smartqueue-ai\resources\views\company\admin\services\edit.blade.php ENDPATH**/ ?>