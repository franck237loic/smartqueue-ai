            ...
            <nav class="sidebar-nav">
                ...
                <?php if($currentCompany): ?>
                    ...
                    <div class="nav-section">
                        ...
                        <?php if(auth()->user()->isSuperAdmin() || auth()->user()->hasRoleInCompany($currentCompany, 'company_admin')): ?>
                            <a href="<?php echo e(route('company.admin.dashboard', $currentCompany)); ?>" 
                               class="nav-item <?php echo e(request()->routeIs('company.admin.*') ? 'active' : ''); ?>">
                        ...
                        <?php if(auth()->user()->hasRoleInCompany($currentCompany, 'agent')): ?>
                            <a href="<?php echo e(route('company.agent.dashboard', $currentCompany)); ?>" 
                               class="nav-item <?php echo e(request()->routeIs('company.agent.*') ? 'active' : ''); ?>">
                                <div class="nav-content">
                    ...
                    <div class="nav-section">
                        ...
                        <a href="<?php echo e(route('company.agent.history', $currentCompany)); ?>" 
                           class="nav-item <?php echo e(request()->routeIs('company.agent.history') ? 'active' : ''); ?>">
                            <div class="nav-content">
                        ...
                        <a href="<?php echo e(route('company.agent.service', [$currentCompany, 'all'])); ?>" 
                           class="nav-item <?php echo e(request()->routeIs('company.agent.service') ? 'active' : ''); ?>">
                            <div class="nav-content">
                                <i class="nav-icon" data-lucide="list"></i>
                                <span class="nav-text">Liste Services</span>
                            </div>
                        </a>
                    </div>
                <?php endif; ?>
                ...
                <div class="nav-section">
                    ...
                    <a href="<?php echo e(route('welcome')); ?>" 
                       class="nav-item <?php echo e(request()->routeIs('welcome') ? 'active' : ''); ?>">
                        <div class="nav-content">
                    ...
                    <?php if(Route::has('company.admin.work-schedules')): ?>
    <a href="<?php echo e(route('company.admin.work-schedules', $currentCompany ?? auth()->user()?->companies()->first())); ?>" 
       class="nav-item <?php echo e(request()->routeIs('company.admin.work-schedules*') ? 'active' : ''); ?>">
        <div class="nav-content">
...
<?php endif; ?>
                    ...
                    <?php if(auth()->user()->isSuperAdmin() || auth()->user()->hasRoleInCompany($currentCompany, 'company_admin')): ?>
                        <a href="<?php echo e(route('company.admin.settings', $currentCompany ?? auth()->user()?->companies()->first())); ?>" 
                           class="nav-item <?php echo e(request()->routeIs('company.admin.settings*') ? 'active' : ''); ?>">
                            <div class="nav-content">
            ...
            <div class="sidebar-footer">
                ...
                <div class="user-profile">
                    ...
                    <div class="user-info">
                        ...
                        <div class="user-role">
                            <?php if($currentCompany): ?>
                                <?php echo e(ucfirst(auth()->user()->companies()->where('company_id', $currentCompany->id)->first()?->pivot->role ?? 'Agent')); ?>
                ...
                <!-- Logout Button -->
                <form method="POST" action="<?php echo e(route('logout.post')); ?>">
                    <?php echo csrf_field(); ?>
            ...
            <div class="bg-white border-b border-gray-200 sticky top-0 z-30">
                <div class="px-6 py-4">
                    <div class="flex items-center justify-between">
                        <div>
                            <h1 class="text-2xl font-bold text-gray-900"><?php echo $__env->yieldContent('title', 'SmartQueue AI'); ?></h1>
                            <?php if($currentCompany): ?>
                                <p class="text-sm text-gray-500 mt-1"><?php echo e($currentCompany->name); ?> - Interface Agent</p>
                            <?php endif; ?>
                        </div>
...
<?php /**PATH C:\Users\FurtherMarket\smartqueue-ai\resources\views\layouts\modern-sidebar.blade.php ENDPATH**/ ?>