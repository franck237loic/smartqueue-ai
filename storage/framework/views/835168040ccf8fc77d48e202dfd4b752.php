...
<head>
    ...
    <title>Dashboard Agent - <?php echo e($company->name); ?></title>
    <script src="https://cdn.tailwindcss.com"></script>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">
    
    <!-- Laravel Echo & Pusher -->
    <?php if(config('services.pusher.key')): ?>
    <script src="https://js.pusher.com/8.2.0/pusher.min.js"></script>
    <script src="<?php echo e(asset('js/smartqueue-echo.js')); ?>"></script>
    <?php endif; ?>
...
<body class="bg-gray-50">
    ...
    <div id="mobileMenu" class="mobile-menu fixed top-0 left-0 w-64 h-full bg-white shadow-xl z-50 md:hidden">
        <div class="p-4 border-b">
            <div class="flex items-center justify-between">
                <h3 class="font-bold text-lg"><?php echo e($company->name); ?></h3>
        ...
        <div class="p-4">
            <div class="space-y-2">
                ...
                <form method="POST" action="<?php echo e(route('logout.post')); ?>" class="mt-4">
                    <?php echo csrf_field(); ?>
        ...
        <div class="container mx-auto px-4 py-4 md:py-6">
            <div class="flex flex-col md:flex-row md:justify-between md:items-center space-y-4 md:space-y-0">
                <div class="flex items-center space-x-3 md:space-x-4">
                    ...
                    <div>
                        <h1 class="text-lg md:text-2xl font-bold"><?php echo e($company->name); ?></h1>
                ...
                <div class="desktop-only flex items-center space-x-4">
                    ...
                    <form method="POST" action="<?php echo e(route('logout.post')); ?>" class="inline">
                        <?php echo csrf_field(); ?>
    ...
    <div id="mobile-menu-sidebar" class="fixed top-0 left-0 h-full w-64 bg-white shadow-xl z-50 transform -translate-x-full transition-transform duration-300 md:hidden">
        <div class="p-4">
            ...
            <nav class="space-y-2">
                <a href="<?php echo e(route('company.agent.dashboard', $company)); ?>" class="flex items-center gap-3 p-3 rounded-lg bg-blue-50 text-blue-600">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('company.agent.history', $company)); ?>" class="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-100">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('company.agent.all-services', $company)); ?>" class="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-100">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <form method="POST" action="<?php echo e(route('logout.post')); ?>" class="pt-2">
                    <?php echo csrf_field(); ?>
            ...
            <div class="card-animate bg-white rounded-xl shadow-lg p-4 md:p-6 hover:shadow-xl transition-shadow">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <p class="text-xl md:text-3xl font-bold text-green-600"><?php echo e($myTicketsToday); ?></p>
            ...
            <div class="card-animate bg-white rounded-xl shadow-lg p-4 md:p-6 hover:shadow-xl transition-shadow" style="animation-delay: 0.1s">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <p class="text-xl md:text-3xl font-bold text-red-600"><?php echo e($missedTicketsToday); ?></p>
                        <p class="text-xs text-gray-400 mt-1">Aujourd'hui</p>
                    </div>
            ...
            <div class="card-animate bg-white rounded-xl shadow-lg p-4 md:p-6 hover:shadow-xl transition-shadow" style="animation-delay: 0.2s">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <p class="text-xl md:text-3xl font-bold text-blue-600"><?php echo e(number_format($avgServiceTime, 1)); ?>s</p>
            ...
            <div class="card-animate bg-white rounded-xl shadow-lg p-4 md:p-6 hover:shadow-xl transition-shadow" style="animation-delay: 0.3s">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <p class="text-xl md:text-3xl font-bold text-purple-600"><?php echo e($serviceRateToday); ?>%</p>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-4 md:gap-6 mb-6">
            <div class="bg-white rounded-xl shadow-lg p-4 md:p-6">
                <div class="flex items-center justify-between mb-4 md:mb-6">
                    ...
                    <span class="bg-blue-100 text-blue-600 px-2 md:px-3 py-1 rounded-full text-xs md:text-sm font-semibold">
                        <?php echo e($services->count()); ?> services
                    </span>
                </div>
                
                <div class="space-y-3 md:space-y-4">
                    <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="border rounded-lg p-3 md:p-4 hover:bg-gray-50 transition-colors service-card" data-service-id="<?php echo e($service->id); ?>">
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-3 md:space-y-0">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <h3 class="font-semibold text-gray-800 text-sm md:text-base"><?php echo e($service->name); ?></h3>
                                    <p class="text-xs md:text-sm text-gray-500"><?php echo e($service->prefix ?? 'N/A'); ?></p>
                                </div>
                            </div>
                        ...
                        <!-- Action buttons -->
                        <div class="mt-3 md:mt-4 grid grid-cols-2 gap-2" id="service-actions-<?php echo e($service->id); ?>">
                            <button onclick="callNextTicket(<?php echo e($service->id); ?>)" class="bg-green-600 hover:bg-green-700 text-white px-3 md:px-4 py-2 rounded-lg transition-colors flex items-center justify-center space-x-2 text-sm">
                                <i class="fas fa-bell"></i>
                                <span class="hidden md:inline">Appeler</span>
                                <span class="md:hidden">Appeler</span>
                            </button>
                            <button onclick="refreshService(<?php echo e($service->id); ?>)" class="bg-gray-200 hover:bg-gray-300 text-gray-700 px-3 py-2 rounded-lg transition-colors">
            ...
            <div class="bg-white rounded-xl shadow-lg p-4 md:p-6">
                ...
                <div class="border-2 border-green-500 rounded-lg p-4 md:p-6 bg-green-50">
                    <div class="text-center">
                        <div class="text-3xl md:text-4xl font-bold text-green-600 mb-2"><?php echo e($currentTicket->number); ?></div>
                        <p class="text-gray-600 mb-4 text-sm md:text-base"><?php echo e($currentTicket->service->name); ?></p>
                        <div class="flex flex-col md:flex-row items-center justify-center space-y-2 md:space-y-0 md:space-x-4 mb-4 md:mb-6">
                            <span class="bg-yellow-100 text-yellow-800 px-3 py-1 rounded-full text-sm font-semibold">
                                <?php echo e($currentTicket->status); ?>

                            </span>
                            <?php if($currentTicket->guest_name): ?>
                            <span class="text-gray-600 text-sm">
                                <i class="fas fa-user"></i> <?php echo e($currentTicket->guest_name); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-4">
                            <button onclick="markAsServed(<?php echo e($currentTicket->id); ?>)" class="bg-green-600 hover:bg-green-700 text-white px-3 md:px-4 py-2 md:py-3 rounded-lg transition-colors flex items-center justify-center space-x-2 text-sm">
                                <i class="fas fa-check"></i>
                                <span>Servi</span>
                            </button>
                            <button onclick="markAsMissed(<?php echo e($currentTicket->id); ?>)" class="bg-orange-600 hover:bg-orange-700 text-white px-3 md:px-4 py-2 md:py-3 rounded-lg transition-colors flex items-center justify-center space-x-2 text-sm">
                                <i class="fas fa-user-clock"></i>
                                <span>Absent</span>
                            </button>
                            <button onclick="recallTicket(<?php echo e($currentTicket->id); ?>)" class="bg-blue-600 hover:bg-blue-700 text-white px-3 md:px-4 py-2 md:py-3 rounded-lg transition-colors flex items-center justify-center space-x-2 text-sm">
                                <i class="fas fa-bell"></i>
                                <span>Rappeler</span>
                            </button>
                        </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-4 md:p-6">
            <div class="flex items-center justify-between mb-4 md:mb-6">
                ...
                <span class="bg-purple-100 text-purple-600 px-2 md:px-3 py-1 rounded-full text-xs md:text-sm font-semibold">
                    <?php echo e($myCounters->count()); ?> guichets
                </span>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <?php $__currentLoopData = $myCounters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $counter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="border rounded-lg p-3 md:p-4 hover:shadow-md transition-shadow">
                    <div class="flex items-center justify-between mb-3">
                        <h3 class="font-semibold text-gray-800 text-sm md:text-base"><?php echo e($counter->name); ?></h3>
                        <div class="w-2 h-2 md:w-3 md:h-3 rounded-full <?php echo e($counter->status === 'open' ? 'bg-green-500' : 'bg-red-500'); ?>"></div>
                    </div>
                    <p class="text-xs md:text-sm text-gray-600 mb-3"><?php echo e($counter->service->name ?? 'Non assigné'); ?></p>
                    <a href="<?php echo e(route('company.agent.counter', [$company, $counter])); ?>" class="block w-full bg-purple-600 hover:bg-purple-700 text-white text-center px-3 md:px-4 py-2 rounded-lg transition-colors text-sm">
                        Accéder au guichet
                    </a>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <script>
        ...
        function initializeRealtimeConnection() {
            ...
            const pusherKey = '<?php echo e(config('services.pusher.key')); ?>';
            ...
            if (pusherKey && pusherKey !== '') {
                ...
                try {
                    echoInstance = new Echo({
                        broadcaster: 'pusher',
                        key: pusherKey,
                        cluster: '<?php echo e(config('services.pusher.cluster', 'mt1')); ?>',
                        wsHost: '<?php echo e(config('services.pusher.host')); ?>',
                        wsPort: <?php echo e(config('services.pusher.port', 443)); ?>,
                        wssPort: <?php echo e(config('services.pusher.port', 443)); ?>,
                        forceTLS: '<?php echo e(config('services.pusher.scheme', 'https')); ?>' === 'https',
                        enabledTransports: ['ws', 'wss'],
                        disableStats: true,
                    });
                    
                    // Subscribe to company channel
                    const channel = echoInstance.channel('company.<?php echo e($company->id); ?>');
        ...
        function initializePollingFallback() {
            ...
            setInterval(async () => {
                try {
                    const response = await fetch(`/api/companies/<?php echo e($company->id); ?>/performance`);
                    if (response.ok) {
...
<?php /**PATH C:\Users\FurtherMarket\smartqueue-ai\resources\views\company\agent\dashboard.blade.php ENDPATH**/ ?>