<?php $__env->startSection('title', 'Modifier Agent - ' . $company->name); ?>
...
<div class="space-y-6">
        ...
        <div class="flex items-center gap-4 mb-6">
            ...
            <div>
                ...
                <p class="text-dark-600">
                    Modifier les informations de <?php echo e($agent->name); ?> pour l'entreprise <?php echo e($company->name); ?>
    ...
    <div class="bg-dark-800 rounded-xl card-shadow">
        <form method="POST" action="<?php echo e(route('company.admin.agents.update', [$company, $agent])); ?>" class="space-y-6">
            <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select name="role" required
                            ...
                            ?>
                            <option value="agent" <?php echo e($currentRole == 'agent' ? 'selected' : ''); ?>>
                                Agent
                            </option>
                            <option value="company_admin" <?php echo e($currentRole == 'company_admin' ? 'selected' : ''); ?>>
                    ...
                    <div>
                        ...
                        <select name="counter_id"
                            ...
                            <option value="<?php echo e($counter->id); ?>" 
                                    <?php echo e(($agentPivot && $agentPivot->pivot->counter_id == $counter->id) ? 'selected' : ''); ?>>
            ...
            <div class="p-6 border-b border-dark-700">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <p class="text-white"><?php echo e($agent->created_at->format('d/m/Y H:i')); ?></p>
                    </div>
                    
                    <div>
                        <p class="text-sm text-dark-600 mb-1">Dernière modification</p>
                        <p class="text-white"><?php echo e($agent->updated_at->format('d/m/Y H:i')); ?></p>
                    </div>
            ...
            <div class="p-6 flex justify-between items-center">
                <div class="flex gap-4">
                    <a href="<?php echo e(route('company.admin.agents', $company)); ?>" 
    ...
    <div class="flex items-center justify-center min-h-screen p-4">
        <div class="bg-dark-800 rounded-xl p-6 max-w-md w-full card-shadow">
            ...
            <p class="text-dark-600 mb-6">
                Êtes-vous sûr de vouloir supprimer l'agent <span class="font-medium text-white"><?php echo e($agent->name); ?></span> ?
            </p>
            ...
            <div class="flex gap-3 justify-end">
                ...
                <form method="POST" action="<?php echo e(route('company.admin.agents.destroy', [$company, $agent])); ?>" class="inline">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.company-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\FurtherMarket\smartqueue-ai\resources\views\company\admin\agents\edit.blade.php ENDPATH**/ ?>