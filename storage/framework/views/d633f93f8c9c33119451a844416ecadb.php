...
<body class="bg-gray-50 min-h-screen">
        ...
        <div class="container mx-auto px-4 py-6">
            <div class="flex items-center justify-between">
                ...
                <div class="text-right">
                    ...
                    <p class="font-mono font-bold"><?php echo e($ticket->number); ?></p>
                </div>
            </div>
        </div>
    </header>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 mb-6 card-animate">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="bg-blue-100 text-blue-600 px-3 py-1 rounded-full text-sm font-semibold">
                    <?php echo e($ticket->service->name); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800"><?php echo e($ticket->number); ?></p>
                </div>
                <div>
                    <p class="text-gray-500 text-sm">Statut actuel</p>
                    <p class="text-lg font-semibold <?php echo e($ticket->status === 'CALLED' ? 'text-orange-600' : 'text-gray-600'); ?>">
                ...
                <div>
                    ...
                    <p class="text-lg font-semibold text-gray-800"><?php echo e($ticket->guest_name); ?></p>
                </div>
                <?php endif; ?>
                <div>
                    <p class="text-gray-500 text-sm">Heure d'appel</p>
                    <p class="text-lg font-semibold text-gray-800">
                        <?php echo e($ticket->called_at ? $ticket->called_at->format('H:i') : '--:--'); ?>
        ...
        <div class="bg-green-50 border-2 border-green-200 rounded-xl p-6 mb-6 card-animate">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    ...
                    <?php if($ticket->client_response_at): ?>
                    <p class="text-sm text-green-500">
                        Réponse envoyée à <?php echo e($ticket->client_response_at->format('H:i')); ?>
    ...
    <script>
        ...
        async function respondToTicket(response) {
            setLoading(true);
            try {
                const response_data = await fetch(`/api/client/tickets/<?php echo e($ticket->id); ?>/respond`, {
                    method: 'POST',
                    headers: {
...
<?php /**PATH C:\Users\FurtherMarket\smartqueue-ai\resources\views\client\ticket-response.blade.php ENDPATH**/ ?>