        ...
        <div class="container">
            <div class="hero-content">
                ...
                <div class="hero-actions">
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-primary" style="font-size: 1.125rem; padding: 1rem 2.5rem;">
                        Accès Dashboard
                    </a>
                    <a href="<?php echo e(route('client.ticket')); ?>" class="btn btn-secondary" style="font-size: 1.125rem; padding: 1rem 2.5rem;">
                        Prendre un ticket
                    </a>
                    <a href="<?php echo e(route('companies.index')); ?>" class="btn btn-outline" style="font-size: 1.125rem; padding: 1rem 2.5rem;">
        ...
        <div class="container">
            <div class="cta-content">
                ...
                <div style="display: flex; gap: 1.5rem; justify-content: center; flex-wrap: wrap;">
                    <a href="<?php echo e(route('companies.index')); ?>" class="btn btn-primary" style="font-size: 1.125rem; padding: 1rem 2.5rem;">
                        Voir les entreprises
                    </a>
                    <a href="<?php echo e(route('client.ticket')); ?>" class="btn btn-outline" style="font-size: 1.125rem; padding: 1rem 2.5rem; border: 2px solid var(--primary-gold); color: var(--primary-gold); background: transparent;">
                        Prendre un ticket
                    </a>
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-secondary" style="font-size: 1.125rem; padding: 1rem 2.5rem;">
                        Commencer
                    </a>
                </div>
            </div>
...
<?php /**PATH C:\Users\FurtherMarket\smartqueue-ai\resources\views\pages\home.blade.php ENDPATH**/ ?>