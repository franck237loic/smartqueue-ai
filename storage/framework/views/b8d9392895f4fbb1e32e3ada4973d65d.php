                ...
                <div class="flex items-center space-x-4">
                    <?php if(Route::has('login')): ?>
                        <?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(route('select-company')); ?>" class="text-gray-600 hover:text-gray-900 transition">
                                Dashboard
                            </a>
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" class="text-gray-600 hover:text-gray-900 transition">
                                Connexion
                            </a>
                            <?php if(Route::has('register')): ?>
                                <a href="<?php echo e(route('register')); ?>" class="hero-gradient text-white px-6 py-2.5 rounded-full font-medium hover:opacity-90 transition shadow-lg shadow-primary-500/30">
                                    Essai Gratuit
                                </a>
                            <?php endif; ?>
                        <?php endif; ?>
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="text-center lg:text-left">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                        <a href="<?php echo e(route('client.ticket')); ?>" class="hero-gradient text-white px-8 py-4 rounded-full font-semibold hover:opacity-90 transition shadow-xl shadow-primary-500/30 inline-flex items-center justify-center">
                            <i data-lucide="ticket" class="mr-2 w-5 h-5"></i>
                            Prendre un ticket
                        </a>
                        <a href="<?php echo e(route('register')); ?>" class="bg-white text-gray-700 border border-gray-300 px-8 py-4 rounded-full font-semibold hover:bg-gray-50 transition inline-flex items-center justify-center">
