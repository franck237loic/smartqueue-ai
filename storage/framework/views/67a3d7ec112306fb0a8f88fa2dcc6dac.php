<?php $__env->startSection('title', 'Réinitialiser Mot de Passe - ' . $company->name); ?>
...
<div class="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-lg">
        <div class="bg-white shadow-xl rounded-lg">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4 rounded-t-lg">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-blue-100 text-sm">Entreprise: <?php echo e($company->name); ?></p>
                    </div>
            ...
            <div class="p-6">
                <!-- Formulaire Manuel -->
                <form method="POST" action="<?php echo e(route('admin.companies.reset-password.post', $company)); ?>" class="space-y-6">
                    <?php echo csrf_field(); ?>
                            ...
                            <div>
                                ...
                                <select name="user_id" required
                                    ...
                                    <option value="<?php echo e($admin->id); ?>">
                                        <?php echo e($admin->name); ?> (<?php echo e($admin->email); ?>) - <?php echo e($admin->pivot->role); ?>
                ...
                <form method="POST" action="<?php echo e(route('admin.companies.auto-reset-password', $company)); ?>" class="space-y-4">
                    <?php echo csrf_field(); ?>
                ...
                <div class="mt-6 flex justify-between">
                    ...
                    <div class="text-sm text-gray-500">
                        Entreprise: <?php echo e($company->name); ?> (<?php echo e($admins->count()); ?> utilisateur(s))
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\FurtherMarket\smartqueue-ai\resources\views\admin\companies\reset-password.blade.php ENDPATH**/ ?>