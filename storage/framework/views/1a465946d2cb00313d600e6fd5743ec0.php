        ...
        <div class="max-w-7xl px-4">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-6">
                    <a href="<?php echo e(route('companies.index')); ?>" class="px-4 py-2 text-medium-gray rounded-lg hover:bg-cream transition font-medium text-sm cursor-pointer flex items-center">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                        </svg>
                        Entreprises
                    </a>
                    <a href="<?php echo e(route('login')); ?>" onclick="window.location.href='<?php echo e(route('login')); ?>'; return false;" class="nuanced-btn px-6 py-2 text-white rounded-xl hover:bg-soft-blue transition font-medium text-sm cursor-pointer shadow-md hover:shadow-xl">
                        Connexion
                    </a>
                </div>
            </div>
        ...
        <div class="max-w-7xl px-4 py-20 relative z-10">
            <div class="text-center animate-fade-in">
                ...
                <div class="flex justify-center space-x-4 mt-8">
                    <a href="<?php echo e(route('login')); ?>" onclick="window.location.href='<?php echo e(route('login')); ?>'; return false;" class="nuanced-btn px-8 py-3 text-white rounded-xl hover:bg-soft-blue transition font-semibold text-lg cursor-pointer shadow-md hover:shadow-xl">
                        Accès Dashboard
                    </a>
                    <a href="<?php echo e(route('companies.index')); ?>" class="px-8 py-3 bg-white bg-opacity-20 text-white rounded-xl hover:bg-opacity-30 transition font-semibold text-lg cursor-pointer backdrop-filter backdrop-blur-sm">
                        Découvrir
                    </a>
                </div>
            </div>
    ...
    <div id="entreprises" class="max-w-7xl px-4 py-16">
        <div class="text-center mb-12">
            ...
            <div class="flex justify-center">
                <a href="<?php echo e(route('companies.index')); ?>" onclick="window.location.href='<?php echo e(route('companies.index')); ?>'; return false;" class="nuanced-btn px-8 py-4 text-white rounded-xl hover:bg-soft-blue transition font-semibold text-lg cursor-pointer inline-flex items-center shadow-md hover:shadow-xl">
...
<?php /**PATH C:\Users\FurtherMarket\smartqueue-ai\resources\views\pages\home_nuanced.blade.php ENDPATH**/ ?>