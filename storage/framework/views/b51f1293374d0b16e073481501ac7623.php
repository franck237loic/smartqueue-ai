...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        <div class="bg-dark-800 rounded-xl p-4 sm:p-6 card-shadow">
            <div class="flex items-center">
                <div class="w-10 h-10 sm:w-12 sm:h-12 bg-brand-500/20 rounded-lg flex items-center justify-center">
                    <svg class="w-5 h-5 sm:w-6 sm:h-6 text-brand-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        <a href="<?php echo e(route('company.admin.counters', $company)); ?>" class="bg-dark-800 rounded-xl p-4 sm:p-6 card-shadow hover:bg-dark-700/50 transition group">
            ...
            <h3 class="font-medium text-white mb-1 text-sm sm:text-base">Guichets</h3>
        ...
        <a href="<?php echo e(route('company.admin.agents', $company)); ?>" class="bg-dark-800 rounded-xl p-4 sm:p-6 card-shadow hover:bg-dark-700/50 transition group">
            ...
            <h3 class="font-medium text-white mb-1 text-sm sm:text-base">Agents</h3>
        ...
        <a href="<?php echo e(route('company.admin.statistics', $company)); ?>" class="bg-dark-800 rounded-xl p-4 sm:p-6 card-shadow hover:bg-dark-700/50 transition group">
            ...
            <h3 class="font-medium text-white mb-1 text-sm sm:text-base">Statistiques</h3>
            <p class="text-xs sm:text-sm text-dark-600">Performances et rapports</p>
        </a>
    </div>
</div>
