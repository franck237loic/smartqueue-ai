...
<div class="max-w-2xl mx-auto animate-fade-in">
    ...
    <div class="bg-white rounded-2xl card-shadow p-8">
        ...
        <form method="POST" action="<?php echo e(route('admin.agents.store')); ?>" class="space-y-6">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex gap-4 pt-4">
                <a href="<?php echo e(route('admin.agents')); ?>" class="flex-1 py-3 px-4 rounded-xl border-2 border-gray-200 text-gray-600 font-medium text-center hover:border-gray-300 transition">
                    Annuler
                </a>
