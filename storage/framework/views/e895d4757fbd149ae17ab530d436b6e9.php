<?php $__env->startSection('title', 'Nouveau Planning - ' . $company->name); ?>
    ...
    <div class="bg-white shadow-sm border-b">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                ...
                <a href="<?php echo e(route('company.admin.work-schedules.index', $company)); ?>" 
                            ...
                            <div class="grid grid-cols-2 gap-2">
                                <?php $__currentLoopData = ['1' => 'Lundi', '2' => 'Mardi', '3' => 'Mercredi', '4' => 'Jeudi', '5' => 'Vendredi', '6' => 'Samedi', '7' => 'Dimanche']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <label class="flex items-center">
                                        <input type="checkbox" name="working_days[]" value="<?php echo e($day); ?>" 
                                               <?php echo e($day <= 5 ? 'checked' : ''); ?>

                                               class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                        <span class="ml-2 text-sm text-gray-700"><?php echo e($name); ?></span>
                                    </label>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
...
const countersByService = <?php echo json_encode($services->map(function($service) {
    return [
        'id' => $service->id, 'counters' => $service->counters->map(function($counter) {
            return [
                'id' => $counter->id, 'name' => $counter->name) ?>;

// Données des agents
const agents = <?php echo json_encode($agents->map(function($agent) {
    return [
...
document.getElementById('scheduleForm').addEventListener('submit', function(e) {
    ...
    fetch('<?php echo e(route('company.admin.work-schedules.store', $company)); ?>', {
        method: 'POST',
        headers: {
    ...
    .then(data => {
        if (data.success) {
            ...
            window.location.href = '<?php echo e(route('company.admin.work-schedules.index', $company)); ?>';
        } else {
            alert(data.message);
        }
    })
...
<?php echo $__env->make('layouts.company-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\FurtherMarket\smartqueue-ai\resources\views\company\admin\work-schedules\create.blade.php ENDPATH**/ ?>