                ...
                <div class="relative">
                    ...
                    >
                        <span id="selectedRoleText">
                            <?php if(old('role')): ?>
                                <?php if(old('role') === 'super_admin'): ?> Super Admin <?php elseif(old('role') === 'company_admin'): ?> Admin Entreprise <?php elseif(old('role') === 'agent'): ?> Agent <?php endif; ?>
                            <?php else: ?>
                    ...
                    <input type="hidden" id="role" name="role" value="<?php echo e(old('role')); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="text-center mt-6">
            <a href="<?php echo e(route('welcome')); ?>" class="text-gray-600 hover:text-gray-900 transition">
                Retour à l'accueil
            </a>
        </div>
    </div>
...
<?php /**PATH C:\Users\FurtherMarket\smartqueue-ai\resources\views\auth\login_old.blade.php ENDPATH**/ ?>