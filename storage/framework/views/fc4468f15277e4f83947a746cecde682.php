...
<div class="space-y-8 animate-fade-in">
    <div class="flex items-center justify-between">
        ...
        <a href="<?php echo e(route('admin.agents.create')); ?>" class="py-3 px-6 rounded-xl gradient-primary text-white font-medium hover:opacity-90 transition inline-flex items-center gap-2">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-2xl card-shadow p-6">
                <div class="flex items-start justify-between mb-4">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <p class="font-semibold text-text text-lg"><?php echo e($agent->name); ?></p>
                ...
                <div class="space-y-3 pt-4 border-t border-gray-100">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <span class="font-semibold text-success"><?php echo e($agent->tickets()->where('status', 'served')->whereDate('served_at', today())->count()); ?></span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-gray-500 text-sm">En appel</span>
                        <span class="font-semibold text-primary"><?php echo e($agent->tickets()->where('status', 'called')->count()); ?></span>
                    </div>
                </div>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <div class="col-span-full text-center py-12 bg-white rounded-2xl card-shadow">
                ...
                <a href="<?php echo e(route('admin.agents.create')); ?>" class="text-primary hover:underline font-medium">Ajouter un agent</a>
            </div>
        <?php endif; ?>
    </div>
</div>
