...
<div class="space-y-8 animate-fade-in">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        ...
        <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
            <a href="<?php echo e(route('admin.queues.create')); ?>" class="py-2 px-3 sm:px-4 rounded-xl gradient-primary text-white font-medium hover:opacity-90 transition inline-flex items-center gap-2 text-sm sm:text-base">
            ...
            <a href="<?php echo e(route('admin.agents.create')); ?>" class="py-2 px-3 sm:px-4 rounded-xl border-2 border-primary text-primary font-medium hover:bg-primary/5 transition inline-flex items-center gap-2 text-sm sm:text-base">
                <svg class="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        <div class="bg-white rounded-2xl card-shadow p-4 sm:p-6">
            <div class="flex items-center justify-between mb-3 sm:mb-4">
                ...
                <span class="text-xl sm:text-2xl font-bold text-text"><?php echo e($stats['total_queues']); ?></span>
            </div>
        ...
        <div class="bg-white rounded-2xl card-shadow p-4 sm:p-6">
            <div class="flex items-center justify-between mb-3 sm:mb-4">
                ...
                <span class="text-xl sm:text-2xl font-bold text-text"><?php echo e($stats['served_today']); ?></span>
            </div>
        ...
        <div class="bg-white rounded-2xl card-shadow p-4 sm:p-6">
            <div class="flex items-center justify-between mb-3 sm:mb-4">
                ...
                <span class="text-xl sm:text-2xl font-bold text-text"><?php echo e($stats['waiting_now']); ?></span>
            </div>
        ...
        <div class="bg-white rounded-2xl card-shadow p-4 sm:p-6">
            <div class="flex items-center justify-between mb-3 sm:mb-4">
                ...
                <span class="text-xl sm:text-2xl font-bold text-text"><?php echo e(round($stats['avg_wait_time'])); ?> min</span>
            </div>
                        ...
                        <div class="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition">
                            ...
                            <div class="grid grid-cols-2 gap-4 mb-3 text-sm">
                                ...
                                <div>
                                    ...
                                    <span class="font-semibold text-text ml-1"><?php echo e($queue->waitingTickets()->count()); ?></span>
                                </div>
                            </div>
                            
                            <div class="text-sm text-gray-500 mb-3">
                                Servis (24h): <?php echo e($queue->servedTickets()->whereDate('served_at', today())->count()); ?>
                    ...
                    <div class="bg-white rounded-2xl card-shadow p-4 sm:p-6">
                        <div class="flex items-center gap-3 sm:gap-4">
                            <div class="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-primary/10 flex items-center justify-center">
                                <span class="text-base sm:text-lg font-bold text-primary"><?php echo e(substr($agent->name, 0, 1)); ?></span>
                            </div>
                            <div class="min-w-0 flex-1">
                                <p class="font-semibold text-text text-sm sm:text-base truncate"><?php echo e($agent->name); ?></p>
