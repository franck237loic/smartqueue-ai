        ...
        <div class="max-w-7xl px-4">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-6">
                    <a href="<?php echo e(route('companies.index')); ?>" class="px-4 py-2 text-indigo rounded-lg hover:bg-purple hover:text-white transition font-medium text-sm cursor-pointer flex items-center border-indigo">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                        </svg>
                        Entreprises
                    </a>
                    <a href="<?php echo e(route('login')); ?>" onclick="window.location.href='<?php echo e(route('login')); ?>'; return false;" class="btn-purple px-6 py-2 rounded-xl hover:bg-indigo transition font-medium text-sm cursor-pointer shadow-purple hover:shadow-xl">
                        Connexion
                    </a>
                </div>
            </div>
        ...
        <div class="max-w-7xl px-4 py-20 relative z-10">
            <div class="text-center animate-fade-in">
                ...
                <div class="flex justify-center space-x-4">
                    <a href="<?php echo e(route('login')); ?>" onclick="window.location.href='<?php echo e(route('login')); ?>'; return false;" class="btn-indigo px-8 py-3 rounded-xl hover:bg-purple transition font-semibold text-lg cursor-pointer shadow-indigo hover:shadow-xl animate-bounce">
                        Accès Dashboard
                    </a>
                    <a href="<?php echo e(route('companies.index')); ?>" class="px-8 py-3 bg-white bg-opacity-30 text-white rounded-xl hover:bg-opacity-40 transition font-semibold text-lg cursor-pointer backdrop-filter backdrop-blur-sm border-yellow">
                        Découvrir
                    </a>
                </div>
            </div>
    ...
    <div id="entreprises" class="max-w-7xl px-4 py-16">
        <div class="text-center mb-12">
            ...
            <div class="flex justify-center">
                <a href="<?php echo e(route('companies.index')); ?>" onclick="window.location.href='<?php echo e(route('companies.index')); ?>'; return false;" class="btn-pink px-8 py-4 rounded-xl hover:bg-red transition font-semibold text-lg cursor-pointer inline-flex items-center shadow-pink hover:shadow-xl animate-pulse">
...
<?php /**PATH C:\Users\FurtherMarket\smartqueue-ai\resources\views\pages\home_visible.blade.php ENDPATH**/ ?>