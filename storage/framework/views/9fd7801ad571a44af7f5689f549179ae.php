            ...
            <div class="nav-content">
                ...
                <div class="nav-actions">
                    <?php if(Route::has('login')): ?>
                        <a href="<?php echo e(route('login')); ?>" class="btn btn-secondary">Connexion</a>
                    <?php endif; ?>
        ...
        <div class="container">
            <div class="hero-content">
                ...
                <div class="hero-buttons">
                    <a href="<?php echo e(route('companies.index')); ?>" class="btn btn-hero btn-hero-white">
        ...
        <div class="container">
            <div class="cta-card">
                ...
                <div class="cta-buttons">
                    <a href="<?php echo e(route('companies.index')); ?>" class="btn btn-cta btn-cta-white">
                        <i data-lucide="rocket" style="width: 20px; height: 20px;"></i>
