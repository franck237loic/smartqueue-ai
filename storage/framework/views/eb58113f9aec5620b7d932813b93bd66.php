        ...
        <div class="container">
            ...
            <div class="companies-grid">
                <?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="company-card animate-fade-in" onclick="selectCompany(<?php echo e($company->id); ?>)">
                        <div class="company-header">
                            ...
                            <div class="company-info">
                                ...
                                <p><?php echo e($company->address ?? 'Adresse non spécifiée'); ?></p>
                            </div>
                        </div>
                        
                        <div class="company-description">
                            <?php echo e($company->description ?? 'Service de gestion de files d\'attente intelligent pour optimiser votre expérience client.'); ?>

                        </div>
                        
                        <div class="company-stats">
                            <div class="stat-item">
                                <div class="stat-value"><?php echo e($company->counters()->count()); ?></div>
                                <div class="stat-label">Guichets</div>
                            </div>
                            <div class="stat-item">
                                <div class="stat-value"><?php echo e($company->services()->count()); ?></div>
                                <div class="stat-label">Services</div>
                            </div>
                            <div class="stat-item">
                                <div class="stat-value"><?php echo e($company->tickets()->whereDate('created_at', today())->count()); ?></div>
...
<?php /**PATH C:\Users\FurtherMarket\smartqueue-ai\resources\views\pages\client-ticket.blade.php ENDPATH**/ ?>