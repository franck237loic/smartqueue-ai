        ...
        <div class="max-w-7xl px-4">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-4">
                    <a href="<?php echo e(route('login')); ?>" onclick="window.location.href='<?php echo e(route('login')); ?>'; return false;" class="px-4 py-2 border-2 text-blue-600 rounded-lg hover:bg-blue-50 transition font-medium text-sm cursor-pointer">Login</a>
    ...
    <div id="entreprises" class="max-w-7xl px-4 py-16">
        <div class="text-center mb-12">
            ...
            <div class="flex justify-center">
                <a href="<?php echo e(route('companies.index')); ?>" onclick="window.location.href='<?php echo e(route('companies.index')); ?>'; return false;" class="px-8 py-4 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition font-semibold text-lg cursor-pointer inline-flex items-center">
...
<?php /**PATH C:\Users\FurtherMarket\smartqueue-ai\resources\views\pages\home_old.blade.php ENDPATH**/ ?>