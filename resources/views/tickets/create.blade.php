...
@section('title', 'Prise de Ticket - SmartQueue AI')
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    <div class="px-6 py-4 border-b border-gray-100">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-sm text-gray-500">{{ $queues->count() }} file(s)</span>
                        </div>
                    </div>
                                ...
                                @foreach($queues as $queue)
                                    <div class="border border-gray-200 rounded-xl p-5 hover:border-blue-300 hover:shadow-lg transition-all duration-300 cursor-pointer group"
                                        ...
                                        <div class="flex items-start space-x-4">
                                            ...
                                            <div class="flex-1">
                                                <h3 class="font-semibold text-gray-900 group-hover:text-blue-600 transition-colors text-lg">{{ $queue->name }}</h3>
                                                <p class="text-gray-600 text-sm mt-1">{{ $queue->description }}</p>
                                                ...
                                                <div class="flex items-center justify-between mt-3">
                                                    <div class="flex items-center space-x-2">
                                                        ...
                                                        <span class="text-xs text-gray-500">Préfixe: {{ $queue->prefix }}</span>
                                                    </div>
                                                    <div class="text-right">
                                                        <div class="text-sm font-semibold text-blue-600">{{ $queue->waitingTickets()->count() }}</div>
