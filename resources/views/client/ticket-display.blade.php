...
<head>
    ...
    <title>Ticket {{ $ticket->number }} - SmartQueue</title>
        ...
        <div class="container mx-auto px-4 py-6">
            <div class="flex items-center justify-between">
                ...
                <div class="text-right">
                    ...
                    <p class="font-mono font-bold text-3xl">{{ $ticket->number }}</p>
                </div>
            </div>
        </div>
    </header>
            ...
            <div class="text-center">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <p class="text-lg font-bold {{ $ticket->status === 'CALLED' ? 'text-orange-600' : 'text-gray-600' }}">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <p class="text-lg font-bold text-gray-800">{{ $ticket->guest_name }}</p>
                    </div>
                    @endif
                </div>
            </div>
