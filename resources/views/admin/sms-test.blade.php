    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <p class="text-lg font-bold {{ config('services.twilio.enabled') ? 'text-green-600' : 'text-red-600' }}">
                            {{ config('services.twilio.enabled') ? '✅ OUI' : '❌ NON' }}
                        </p>
                    </div>
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <p class="text-sm text-gray-500">Numéro Twilio</p>
                        <p class="text-lg font-mono text-gray-800">
                            {{ config('services.twilio.from') ?: 'Non configuré' }}
                        </p>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 mb-6">
                ...
                <form method="POST" action="{{ route('admin.sms.test.send') }}" class="space-y-4">
                    @csrf
                    <div>
                        ...
                        <input type="tel" name="phone" 
                               ...
                               value="{{ old('phone', '+33612345678') }}" required>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="message" rows="3" 
                                  class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                  placeholder="Message de test..." required>{{ old('message', 'SmartQueue: Test d\'envoi SMS - ' . now()->format('H:i:s')) }}</textarea>
                    </div>
