...
@section('title', 'Files d\'attente - SmartQueue AI')
...
<div class="space-y-8 animate-fade-in">
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('admin.queues.create') }}" class="py-3 px-6 rounded-xl gradient-primary text-white font-medium hover:opacity-90 transition inline-flex items-center gap-2">
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            <td class="px-6 py-4">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">{{ Str::limit($queue->description, 50) }}</p>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4 text-gray-600">{{ $queue->estimated_service_time }} min</td>
                            <td class="px-6 py-4 text-gray-600">{{ $queue->user->name }}</td>
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-1">
                                    <a href="{{ route('admin.queues.edit', $queue) }}" class="p-2 rounded-lg hover:bg-gray-100 text-gray-500 hover:text-primary transition" title="Modifier">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                        </svg>
                                    </a>
                                    <a href="{{ route('admin.statistics', $queue) }}" class="p-2 rounded-lg hover:bg-gray-100 text-gray-500 hover:text-primary transition" title="Statistiques">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
                                        </svg>
                                    </a>
                                    <form method="POST" action="{{ route('admin.queues.destroy', $queue) }}" class="inline" onsubmit="return confirm('Supprimer cette file ? Tous les tickets seront perdus.')">
                                        @csrf
                                        @method('DELETE')
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="px-6 py-12 text-center">
                                ...
                                <a href="{{ route('admin.queues.create') }}" class="text-primary hover:underline font-medium">Créer votre première file</a>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
