...
<div class="space-y-6">
        ...
        <div class="bg-dark-800 rounded-xl p-6 card-shadow">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-white">{{ $stats['services_count'] }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-dark-800 rounded-xl p-6 card-shadow">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-white">{{ $stats['counters_count'] }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-dark-800 rounded-xl p-6 card-shadow">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-white">{{ $stats['agents_count'] }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-dark-800 rounded-xl p-6 card-shadow">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-white">{{ $stats['tickets_today'] }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-dark-800 rounded-xl card-shadow overflow-hidden">
        <div class="p-6 border-b border-dark-700 flex justify-between items-center">
            ...
            <a href="{{ route('company.admin.services.create', $company) }}" class="px-4 py-2 bg-brand-600 text-white rounded-lg hover:bg-brand-700 text-sm font-medium shadow-lg shadow-brand-600/30">
                + Nouveau Service
            </a>
        </div>
        <div class="divide-y divide-dark-700">
            ...
            <div class="p-6 flex items-center justify-between hover:bg-dark-700/50 transition">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-sm text-dark-600">
                            {{ $service->tickets_count }} tickets aujourd'hui
                            • {{ $service->estimated_service_time }} min/ticket
                        </p>
                    </div>
                </div>
                <div class="flex items-center gap-4">
                    ...
                    <a href="{{ route('company.admin.services.edit', [$company, $service]) }}" class="text-brand-500 hover:text-brand-400 text-sm">
                        Modifier
                    </a>
                </div>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <a href="{{ route('company.admin.counters', $company) }}" class="bg-dark-800 rounded-xl p-6 card-shadow hover:bg-dark-700/50 transition group">
        ...
        <a href="{{ route('company.admin.agents', $company) }}" class="bg-dark-800 rounded-xl p-6 card-shadow hover:bg-dark-700/50 transition group">
        ...
        <a href="{{ route('company.admin.statistics', $company) }}" class="bg-dark-800 rounded-xl p-6 card-shadow hover:bg-dark-700/50 transition group">
