...
@section('title', 'Gestion des Agents - ' . $company->name)
        ...
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-dark-600">
                    Gérez les agents de l'entreprise {{ $company->name }}
                </p>
            </div>
            <a href="{{ route('company.admin.agents.create', $company) }}" class="px-6 py-3 bg-brand-600 text-white rounded-lg hover:bg-brand-700 font-medium shadow-lg shadow-brand-600/30 flex items-center gap-2">
    ...
    <div class="bg-dark-800 rounded-xl card-shadow overflow-hidden">
        <div class="p-6 border-b border-dark-700">
            <div class="flex items-center justify-between">
                <h2 class="text-lg font-bold text-white">Agents ({{ $agents->count() }})</h2>
        ...
        <div class="divide-y divide-dark-700">
            ...
            <div class="p-6 hover:bg-dark-700/50 transition agent-row" data-name="{{ strtolower($agent->name) }}">
                <div class="flex items-center justify-between">
                    <!-- Agent Info -->
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-dark-600">{{ $agent->email }}</p>
                    ...
                    <div class="flex items-center gap-3">
                        <!-- View Details -->
                        <button onclick="showAgentDetails({{ $agent->id }})" 
                        ...
                        <!-- Edit -->
                        <a href="{{ route('company.admin.agents.edit', [$company, $agent]) }}" 
                        ...
                        <!-- Delete -->
                        <button onclick="confirmDeleteAgent({{ $agent->id }}, '{{ $agent->name }}')" 
            ...
            <div class="p-12 text-center">
                ...
                <a href="{{ route('company.admin.agents.create', $company) }}" 
...
function confirmDeleteAgent(agentId, agentName) {
    ...
    document.getElementById('deleteForm').action = `/company/{{ $company->id }}/admin/agents/${agentId}`;
