            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-12 items-center">
                ...
                <div class="text-center lg:text-left order-2 lg:order-1">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center sm:justify-start lg:justify-start">
                        <a href="{{ route('client.ticket') }}" class="hero-btn text-white px-6 py-3 sm:px-8 sm:py-4 rounded-full font-semibold shadow-xl shadow-primary-500/30 inline-flex items-center justify-center text-sm sm:text-base btn-hover">
                            <i data-lucide="ticket" class="mr-2 w-4 h-4 sm:w-5 sm:h-5"></i>
                            Prendre un ticket
                        </a>
                        <a href="{{ route('register') }}" class="bg-white text-gray-700 border border-gray-300 px-6 py-3 sm:px-8 sm:py-4 rounded-full font-semibold hover:bg-gray-50 hover:shadow-lg transition-all duration-300 inline-flex items-center justify-center text-sm sm:text-base btn-hover">
