...
<body>
        ...
        <div class="max-w-7xl px-4">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-6">
                    <a href="{{ route('welcome') }}" class="px-4 py-2 text-slate-600 rounded-lg hover:bg-slate-50 transition font-medium text-sm cursor-pointer flex items-center">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
                        </svg>
                        Accueil
                    </a>
                    <a href="{{ route('login') }}" onclick="window.location.href='{{ route('login') }}'; return false;" class="premium-btn px-6 py-2 text-white rounded-xl hover:bg-blue-800 transition font-medium text-sm cursor-pointer shadow-md hover:shadow-xl">
                        Connexion
                    </a>
                </div>
            </div>
        ...
        <div class="max-w-7xl px-4 py-20 relative z-10">
            <div class="text-center animate-fade-in">
                <div class="inline-flex items-center px-4 py-2 bg-white bg-opacity-20 rounded-full text-sm font-medium mb-6 backdrop-filter backdrop-blur-sm">
                    ...
                    {{ App\Models\Company::where('status', 'active')->count() }} entreprises actives
                </div>
    ...
    <div class="max-w-7xl px-4 py-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="premium-card rounded-2xl p-6 hover:shadow-xl transition-all duration-300 hover:scale-105 animate-fade-in" style="animation-delay: {{ $loop->index * 0.1 }}s">
                ...
                <div class="mb-6">
                    <h3 class="font-bold text-xl text-slate-900 mb-2">{{ $company->name }}</h3>
                    <p class="text-slate-600 text-sm leading-relaxed">{{ $company->description ?? 'Gestion de file d\'attente moderne et efficace' }}</p>
                </div>
                ...
                <div class="space-y-3 mb-6">
                    <div class="flex items-center text-sm text-slate-600">
                        ...
                        <span class="font-medium">{{ $company->city ?? 'Non spécifiée' }}</span>
                    </div>
                    <div class="flex items-center text-sm text-slate-600">
                        <svg class="w-4 h-4 mr-3 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                        </svg>
                        <span class="font-medium">{{ $company->email ?? 'contact@example.com' }}</span>
                    </div>
                    <div class="flex items-center text-sm text-slate-600">
                        <svg class="w-4 h-4 mr-3 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                        </svg>
                        <span class="font-medium">{{ $company->phone ?? 'Non spécifié' }}</span>
                    </div>
                </div>
                
                <div class="flex gap-3">
                    <a href="{{ route('login') }}" class="flex-1 premium-btn px-4 py-3 text-white rounded-xl hover:bg-blue-800 transition font-medium text-sm text-center cursor-pointer shadow-md hover:shadow-xl">
        ...
        <div class="text-center py-16 bg-white rounded-2xl shadow-lg">
            ...
            <a href="{{ route('welcome') }}" class="premium-btn px-6 py-3 text-white rounded-xl hover:bg-blue-800 transition font-medium cursor-pointer shadow-md hover:shadow-xl">
                Retour à l'accueil
            </a>
        </div>
        @endif
