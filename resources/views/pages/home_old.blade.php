...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        /* Gradients */
        .bg-gradient-to-br { background-image: linear-gradient(to bottom right, #2563eb, #1d4ed8); }
...
<body>
    <!-- Header -->
    <nav class="bg-white border-slate-200 sticky top-0 z-50">
        <div class="max-w-7xl px-4">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-4">
                    <a href="{{ route('login') }}" onclick="window.location.href='{{ route('login') }}'; return false;" class="px-4 py-2 border-2 text-blue-600 rounded-lg hover:bg-blue-50 transition font-medium text-sm cursor-pointer">Login</a>
                    <a href="{{ route('login') }}" onclick="window.location.href='{{ route('login') }}'; return false;" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition font-medium text-sm cursor-pointer">Dashboard</a>
                </div>
            </div>
        </div>
    </nav>
    ...
    <div class="bg-gradient-to-br text-white">
        <div class="max-w-7xl px-4 py-20">
            <div class="text-center">
                <h1 class="text-4xl font-bold mb-6">Gestion Intelligente de File d'Attente</h1>
                ...
                <div class="flex justify-center space-x-4">
                    <a href="{{ route('login') }}" onclick="window.location.href='{{ route('login') }}'; return false;" class="px-6 py-3 bg-white text-blue-700 rounded-xl hover:bg-blue-50 transition font-semibold cursor-pointer">
                        Accès Dashboard
                    </a>
                </div>
            </div>
    ...
    <div id="entreprises" class="max-w-7xl px-4 py-16">
        <div class="text-center mb-12">
            <h2 class="text-3xl font-bold text-slate-900 mb-4">Découvrez Nos Entreprises Partenaires</h2>
            ...
            <div class="flex justify-center">
                <a href="{{ route('companies.index') }}" onclick="window.location.href='{{ route('companies.index') }}'; return false;" class="px-8 py-4 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition font-semibold text-lg cursor-pointer inline-flex items-center">
