        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-4">
                    <a href="{{ route('login') }}" onclick="window.location.href='{{ route('login') }}'; return false;" class="px-4 py-2 border-2 border-blue-600 text-blue-600 rounded-lg hover:bg-blue-50 transition font-medium text-sm cursor-pointer">Login</a>
    ...
    <div id="entreprises" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="p-6 rounded-2xl bg-slate-50 hover:bg-blue-50 transition-colors">
                ...
                <p class="text-slate-500 text-sm">{{ $company->description }}</p>
            </div>
            @endforeach
        </div>
    </div>
